...
This repository is used to track [OpenJDK 27](https://github.com/openjdk/jdk/tree/jdk27).
...
_develop_
: The default branch. The branch that consumes development and patches to upstream [openjdk/jdk:jdk27](https://github.com/openjdk/jdk/tree/jdk27). Corretto builds are generated from this branch.
